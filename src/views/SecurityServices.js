...
<div id='services' className='px-6 md:px-16 lg:px-44 xl:px-60 py-10'>
      ...
      <p className="text-gray-800"><span className="mt-3">Head Office: </span> Secure Security Guards Ltd,
       Suite E, 1st floor Phoenix Building, 3 Ajax Works, Hertford Rd, IG11 8DY</p>
