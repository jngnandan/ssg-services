...
//           <div className='pt-4'>
//             <h3 className='text-white text-lg font-semibold'>Full access to the gym</h3>
//               <div>
//               <p className='text-sm text-white pt-2'>You can come for boxing to practice personally</p>
